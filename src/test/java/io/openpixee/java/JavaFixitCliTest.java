...
final class JavaFixitCliTest {
    ...
    void defaults_includes_excludes_are_good() {
        IncludesExcludes includesExcludes = IncludesExcludes.fromConfiguration(new File("."), JavaFixitCli.defaultIncludes, JavaFixitCli.defaultExcludes);
        assertThat(includesExcludes.shouldInspect(file("src/main/java/Foo.java")), is(true));
        assertThat(includesExcludes.shouldInspect(file("src/main/resources/WEB-INF/web.xml")), is(true));
        ...
        assertThat(includesExcludes.shouldInspect(file("module1/src/main/resources/WEB-INF/web.xml")), is(true));
