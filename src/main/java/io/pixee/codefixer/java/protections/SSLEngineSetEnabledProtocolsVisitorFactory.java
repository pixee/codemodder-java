...
/**
 * Targets making sure the protocols set in {@link javax.net.ssl.SSLEngine#setEnabledProtocols(String[])} are safe.
 */
public final class SSLEngineSetEnabledProtocolsVisitorFactory extends SSLProtocolsVisitorFactory {
    ...
    private static final String tlsVersionUpgradeRuleId = "pixee:java/tls-version-upgrade-sslengine-setenabledprotocols";
}
