...
/**
 * Targets making sure the protocols set in {@link javax.net.ssl.SSLSocket#setEnabledProtocols(String[])} are safe.
 */
public final class SSLSocketSetEnabledProtocolsVisitorFactory extends SSLProtocolsVisitorFactory {
    ...
    private static final String tlsVersionUpgradeRuleId = "pixee:java/tls-version-upgrade-sslsocket-setenabledprotocols";
}
