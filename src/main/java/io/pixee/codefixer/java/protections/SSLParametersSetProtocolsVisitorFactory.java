...
/**
 * Targets making sure the protocols set in {@link javax.net.ssl.SSLParameters#setProtocols(String[])} are safe.
 */
public final class SSLParametersSetProtocolsVisitorFactory extends SSLProtocolsVisitorFactory {
    ...
    private static final String tlsVersionUpgradeRuleId = "pixee:java/tls-version-upgrade-sslparameters-setprotocols";
}
