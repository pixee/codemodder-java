...
public final class PredictableSeedVisitorFactory implements VisitorFactory {
  ...
  public ModifierVisitor<FileWeavingContext> createJavaCodeVisitorFor(
    ...
    List<Predicate<MethodCallExpr>> predicates = List.of(
            ...
            MethodCallPredicateFactory.withScopeType(cu, "java.util.Random").or(MethodCallPredicateFactory.withScopeType(cu, "java.security.SecureRandom")),
    ...
    Transformer<MethodCallExpr, MethodCallExpr> transformer = new Transformer<>() {
      ...
      public TransformationResult<MethodCallExpr> transform(final MethodCallExpr methodCallExpr, final FileWeavingContext context) {
        ...
        Weave weave = Weave.from(methodCallExpr.getRange().get().begin.line, unpredictableSeedRuleId);
