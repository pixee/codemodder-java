...
/**
 * Targets making sure the protocols set in {@link javax.net.ssl.SSLContext#getInstance(String)} are safe.
 */
public final class SSLContextGetInstanceVisitorFactory implements VisitorFactory {
  ...
  public ModifierVisitor<FileWeavingContext> createJavaCodeVisitorFor(
    ...
    Predicate<MethodCallExpr> isUnsafeArgument = new Predicate<MethodCallExpr>() {
      @Override
    ...
    Predicate<MethodCallExpr> isUnsafeVariable = new Predicate<MethodCallExpr>() {
      @Override
      public boolean test(final MethodCallExpr methodCallExpr) {
  ...
  private static final String tlsVersionUpgradeRuleId = "pixee:java/tls-version-upgrade-sslcontext-getinstance";
