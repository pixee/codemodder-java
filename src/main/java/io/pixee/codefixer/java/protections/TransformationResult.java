...
public final class TransformationResult<T> {
    ...
    /**
     *
     * @param replacementNode the node that should be returned by the {@link com.github.javaparser.ast.visitor.ModifierVisitor} event method
    ...
    /**
     * The node that should be returned by the {@link com.github.javaparser.ast.visitor.ModifierVisitor} event method, if any.
     */
