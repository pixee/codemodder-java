    ...
    Transformer<MethodCallExpr> transformer = new Transformer<>() {
      ...
      public TransformationResult<MethodCallExpr> transform(final MethodCallExpr methodCallExpr, final FileWeavingContext context) throws TransformationException {
        ...
        if(methodRef.isEmpty()) {
          throw new TransformationException("shouldn't be transforming deserialization outside method bodies");
        }
        ...
        boolean wasDeclaredOutsideScope =
                scope.isNameExpr()
                        ...
                        .noneMatch(
                                var -> Objects.equals(scope.toString(), var.getNameAsString()));
        ...
        Weave weave = Weave.from(methodCallExpr.getRange().get().begin.line, deserializationRuleId);
