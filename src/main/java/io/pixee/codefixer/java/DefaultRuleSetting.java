...
/**
 * During analysis, this will be the default setting for every rule. All of the rules listed in the 'exceptions' section
 * of the configuration will be considered the other, opposite value.
 */
