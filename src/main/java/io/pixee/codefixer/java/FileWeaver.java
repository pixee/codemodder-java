...
/**
 * This type is responsible for performing all the weaves that are not run on traditional Java source code. It is meant
 * to operate XML, JSP, and everything else that's not better handled by {@link VisitorFactory}.
 */
                            ...
                            for (File filePath : files) {
                                ...
                                WeavingResult result =
                                        fileBasedWeaver.visitRepositoryFile(
                                                repositoryRoot, canonicalFile, context, javaSourceWeaveResult.changedFiles());
