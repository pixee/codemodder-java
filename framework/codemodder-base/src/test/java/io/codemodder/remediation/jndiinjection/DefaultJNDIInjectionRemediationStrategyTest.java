...
final class DefaultJNDIInjectionRemediationStrategyTest {
    ...
    void it_doesnt_fix_unfixable(final String unfixableCode, final int line, final String failReason) {
        ...
        CodemodFileScanningResult result = remediator.remediateAll(cu, "JNDIUtil.java", rule, List.of(issue),
    ...
    private static Stream<Arguments> unfixableSamples() {
        return Stream.of(
            ...
            Arguments.of("""
                    ...
                    """, 5, RemediationMessages.multipleCallsFound),
                Arguments.of("""
                class Foo {
                      static {
                            String name = "foo";
                ...
                """, 5, "No method found around lookup call")
        );
    }
