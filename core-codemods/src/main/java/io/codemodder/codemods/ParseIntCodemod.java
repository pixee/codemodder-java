...
public final class ParseIntCodemod extends SonarPluginJavaParserChanger<MethodCallExpr> {

  @Inject
  public ParseIntCodemod(@ProvidedSonarScan(ruleId = "java:S2130") final RuleIssues issues) {
